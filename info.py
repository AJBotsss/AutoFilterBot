...
BOT_TOKEN = environ.get('BOT_TOKEN', '6635899847:AAH9iSG24XB0KY8FKvFP8U2dqSse1uIRSv8')
...
# Bot images & videos
PICS = (environ.get('PICS', 'https://graph.org/file/91aa80b0ccbcf74e138ca.jpg')).split()
REQ_PICS = (environ.get('REQ_PICS', 'https://graph.org/file/aa817252b4f2858d697c9.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001999375474').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002059534806')
...
SUPPORT_CHAT_ID = -1002067504645
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Thalpathy:Thalapathy@cluster0.wt2hv2p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Thalapthy")
